...
Check font styles. Use [IBM Plex Sans, sans-serif](https://fonts.google.com/specimen/IBM+Plex+Sans?query=ibm), [Montserrat, sans-serif](https://fonts.google.com/specimen/Montserrat, sans-serif?query=mon)
...
13. Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://Peephie.github.io/Museum/).
